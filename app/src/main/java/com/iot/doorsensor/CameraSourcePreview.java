...
public class CameraSourcePreview extends ViewGroup {
    private static final String TAG = "DoorSensorIoT:Preview";
...
//        int childHeight = (int) (((float) viewWidth / (float) previewWidth) * previewHeight);
//
//        // If height is too tall using fit width, does fit height instead.
//        if (childHeight > viewHeight) {
//            childHeight = viewHeight;
//            childWidth = (int) (((float) viewHeight / (float) previewWidth) * previewHeight);
//        }
