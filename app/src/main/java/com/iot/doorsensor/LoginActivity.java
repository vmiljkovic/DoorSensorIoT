...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            DoorSensorIoT.mServiceCaller.mUserName = email;
            DoorSensorIoT.mServiceCaller.mPassword = password;
            CallerTask mCallTask = new CallerTask(DoorSensorIoT.mServiceCaller,"login",
                            ...
                            try {
                                ...
                                if (json instanceof JSONObject) {
                                    ...
                                    if (((JSONObject) json).has("message")) {
                                        ...
                                        if (message.contains("Uspe")) {
                                            SaveSharedPreference.setUserCredentials(DoorSensorIoT.getContext(), email, password);
    ...
    private void attemptRegister() {
        ...
        if (cancel) {
            ...
            DoorSensorIoT.mServiceCaller.mUserName = email;
            DoorSensorIoT.mServiceCaller.mPassword = password;
            CallerTask mCallTask = new CallerTask(DoorSensorIoT.mServiceCaller,"register",
                    new ServiceCaller.VolleyCallback(){
                        @Override
                        public void onSuccess(@NonNull String result){
                            showProgress(false);
